            ...
            <section className='about-me__content'>
                <div className='about-me__container'>
                    ...
                    <div className='about-me__text-content'>
                        ...
                        <p className='about-me__info about-me__info-text'>Я родился в Уфе, живу в Москве, закончил юридический факультет Башкирского института социальный технологоий.
                    ...
                    <a href='https://github.com/Phentality' className="about-me__link" target="_blank" rel="noopener noreferrer">Github</a>      
                </div>
            </section>
        </section>)
}
